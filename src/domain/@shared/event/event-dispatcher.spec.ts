...
import ShowMessageWhenCustomerAddressIsChanged from "../../customer/event/handler/show-message-when-customer-address-is-changed.handler";
import ShowMessage1WhenCustomerIsCreated from "../../customer/event/handler/show-message1-when-customer-is-created.handler";
import ShowMessage2WhenCustomerIsCreated from "../../customer/event/handler/show-message2-when-customer-is-created.handler";
